...
public class Register extends javax.swing.JFrame {
    ...
    public Register() {
        ...
        // create a red border for the jpanel_tittle
        ...
        Button.add(jRadioButton_Male);
        Button.add(jRadioButton_Female);
    }
        ...
        if (VerifyFields()) {
            if (!CheckUsername(Username)) {
                ...
                try {
                    ...
                    PreparedStat.setString(1, Fullname);
                    PreparedStat.setString(2, Username);
                    PreparedStat.setString(3, Pass1);
                    PreparedStat.setString(4, Phone);
                    PreparedStat.setString(5, Gender);
                    PreparedStat.setString(6, "null");
    ...
    // create unction to check if the entred username already exist in the database
